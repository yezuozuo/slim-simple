...
case when a.COLUMN_DEFAULT='' then '""' when ISNULL(a.COLUMN_DEFAULT) then 'NULL' else a.COLUMN_DEFAULT end  as '默认值',
...
<head>
    ...
    .dbdict-block table td { line-height: 20px; padding: 7px 10px;}
    </style>
</head>
<body>
